package org.chaney.restaurantreviewer.config;

import org.chaney.restaurantreviewer.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/userInfo","/review/reviewCreation","/review/reviewDashboard","/review/deleteReview").access("hasAnyRole('ROLE_USER', 'ROLE_ADMIN')");
